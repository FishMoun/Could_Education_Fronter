    ...
    <div class="left">
      <div class="selectBox">
        <SemesterSelect
          ...
          @changeSemCallback="changeSemCallback"
        />
      </div>
      <ul class="courses">
        <el-scrollbar height="370px">
          <li
            ...
            :key="course.id"
            :class="
              curCourse.courseId === course.courseId ? 'activeCourse' : ''
            "
          >
            <CourseItem
              :course="course"
      ...
      >
        ...
        <template #footer>
          <span class="dialog-footer">
            ...
            <el-button type="primary" @click="addMsg"> 发送消息 </el-button>
          </span>
        </template>
      </el-dialog>
      <ul>
        <el-scrollbar height="80vh">
          <div class="msgListHeader">
            ...
            <el-button
              ...
              v-show="this.$store.state.isTeacher"
              >+发送课程消息</el-button
            >
          </div>
          <li
            ...
            :key="message.id"
            class="msgItem"
            @click="checkMsg(message)"
          >
            <CourseMessageItem :message="message" />
          </li>
          <li v-if="messages.length === 0" class="msgItem">当前没有消息</li>
        </el-scrollbar>
      </ul>
    </div>
  </div>
